    ...
    public Void doInBackground(String... strings) {
        ...
        for (String s2 : strings) {
            ...
            for (int i = 0; i < responses.size(); i++) {
                ...
                results.add(sss.result(responses.get(i)));
            }
            ...
            contentValues.put(dbHelper.DRAG_FILTER, Integer.toString(result));
            contentValues.put(dbHelper.EXTREMIST_FILTER, Integer.toString(result));
            contentValues.put(dbHelper.THEFT_FILTER, Integer.toString(result));
            contentValues.put(dbHelper.PROFANITY_FILTER, Integer.toString(result));
            contentValues.put(dbHelper.STATE_SECRET_FILTER, Integer.toString(result));
            contentValues.put(dbHelper.BANK_SECRET_FILTER, Integer.toString(result));
